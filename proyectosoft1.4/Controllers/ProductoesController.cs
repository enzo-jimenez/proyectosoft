...
namespace proyectosoft1._4.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProId,ProNombre,ProPrecio,ProDisponible,ProDescripcion")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("ProId,ProNombre,ProPrecio,ProDisponible,ProDescripcion")] Producto producto)
        {
